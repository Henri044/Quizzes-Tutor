...
@DataJpaTest
    ...
    def "create an empty dashboard"() {
        ...
        studentDashboardService.createStudentDashboard(externalCourseExecution.getId(), student.getId())
    ...
    def "cannot create a dashboard with courseExecutionId=#courseExecutionId"() {
        when: "a dashboard is created"
        studentDashboardService.createStudentDashboard(courseExecutionId, student.getId())
    ...
    def "cannot create a dashboard with studentId=#studentId"() {
        when: "a dashboard is created"
        studentDashboardService.createStudentDashboard(externalCourseExecution.getId(), studentId)
