...
@DataJpaTest
    ...
    def "create an empty dashboard"() {
        ...
        dashboardService.getTeacherDashboard(externalCourseExecution.getId(), teacher.getId())
    ...
    def "cannot create a dashboard with courseExecutionId=#courseExecutionId"() {
        when: "a dashboard is created"
        dashboardService.createTeacherDashboard(courseExecutionId, teacher.getId())
    ...
    def "cannot create a dashboard with teacherId=#teacherId"() {
        when: "a dashboard is created"
        dashboardService.createTeacherDashboard(externalCourseExecution.getId(), teacherId)
